...
choose one of the following:
    ...
    (5) Isp and twr multiple values from analytical results
    (6) saved data for multiple Isp, twr with constant thrust
"""
...
if ch==1: #Isp and twr single values, constant thrust (no throttle)
    ...
    t0 = np.array([0.1, 0.5, 1.])*1e3 #time of flight initial guess and bounds (s)
    ...
    d = a.get_results()
    #savemat("data/throttle_450_21_lgl_5_11", d)
...
elif ch==5: #Isp and twr multiple values from analytical results
...
elif ch==6: #saved data for multiple Isp, twr
