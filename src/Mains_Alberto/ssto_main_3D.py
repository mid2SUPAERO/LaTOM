...
#initial guess
t0 = np.array([1., 5., 10.])*1e3 #time of flight initial guess and bounds (s)
u0 = np.array([[0.8, 0.1, -0.3],[0.1, 0.1, 0.1]]) #thrust direction initial guess as [[ux0, uy0, uz0], [uxf, uyf, uzf]]
...
e = 0.7
a = rp/(1-e)
coe = np.array([a, e, 60.0, 0.0, 270.0, 10.])
