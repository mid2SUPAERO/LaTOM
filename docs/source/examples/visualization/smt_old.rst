.. note::
    ...
    Click :ref:`here <sphx_glr_download_examples_visualization_smt_old.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_visualization_smt_old.py:
...
.. _sphx_glr_download_examples_visualization_smt_old.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: smt_old.py <smt_old.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: smt_old.ipynb <smt_old.ipynb>`
